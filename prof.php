...
<html xmlns="http://www.w3.org/1999/xhtml" lang="fr" xml:lang="fr"><html>
		...
		<div class="col-md-3">
			<div class="profile-sidebar">
				...
				<div class="profile-userpic">
					<img src="user_ens.png" class="img-responsive" alt="">
				</div>
				<!-- END SIDEBAR USERPIC -->
				<!-- SIDEBAR USER TITLE -->
				<div class="profile-usertitle">
					...
					<div class="profile-usertitle-job">
						enseignant en département d'informatique
					</div>
				</div>
...
<div style="margin-top: -550px;margin-right: 90px; font-size: 16px;height:400px;">
<table id="table_18" border="1" class="even_table" style="background-color: white;">
      ...
      <tbody>
        <tr>
          ...
          <?php 
        $sql = " SELECT * FROM timetable WHERE  name_t = '". $user ."' AND day = 'Samdi'
...
$row = mysqli_fetch_array($result); 
 ...
 ?>
        ...
        <?php 
        $sql = " SELECT * FROM timetable WHERE  name_t = '". $user ."' AND day = 'Dimanche'
         AND hour='08:00-09:30' ;";
...
$row = mysqli_fetch_array($result); 
 ...
 <?php 
        $sql = " SELECT * FROM timetable WHERE  name_t = '". $user ."' AND day = 'Lundi'
         AND hour='08:00-09:30' ;";
...
$row = mysqli_fetch_array($result); 
 ...
 <?php 
        $sql = " SELECT * FROM timetable WHERE  name_t = '". $user ."' AND day = 'Mardi'
         AND hour='08:00-09:30' ;";
...
$row = mysqli_fetch_array($result); 
 ...
 ?>
     ...
     <?php 
        $sql = " SELECT * FROM timetable WHERE  name_t = '". $user ."' AND day = 'Mercredi'
         AND hour='08:00-09:30' ;";
...
$row = mysqli_fetch_array($result); 
 ...
 <?php 
        $sql = " SELECT * FROM timetable WHERE  name_t = '". $user ."' AND day = 'Jeudi'
         AND hour='08:00-09:30' ;";
