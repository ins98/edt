...
margin:3px;display:block;
  ...
  text-shadow:1px 1px 0px #fa8072;">EDT :  Emploi du temps universitaire en ligne 
     <br>
     &nbsp;&nbsp;&nbsp;&#8223;génération automatique,essai gratuit ,<br> facile, rapide, entièrement en ligne.&#8221;<br><br>Statistiques  </h1>
     <br>
...
<div id="Home" class="tabcontent">
  <h1>Consulte les différents statistiques des enseignants :</h1><br>
  <a href="fet/timetables/file/file_students_statistics.html" style="color: black">Les statistiques d'enseignants par raport d'apprenants</a><br><br><br><br>

  <a href="fet/timetables/file/file_students_statistics.html" style="color: black">Les statistiques d'enseugnants par raport des matières</a><br><br><br><br>


</div>

<div id="About" class="tabcontent">
  <h1>Consulte les différents statistiques d'apprenants :</h1><br>

  <a href="fet/timetables/file/file_teachers_statistics.html" style="color: black">Les statistiques d'apprenants par raport d'enseignants </a>
  <h1>   </h1>

  <a href="fet/timetables/file/file_students_statistics.html" style="color: black">Les statistiques d'apprenants par raport des matières </a><br><br>

  

</div>
<div id="module" class="tabcontent">
<h1>Consulte les différents statistiques des matières :</h1><br>

  <a href="fet/timetables/file/file_students_statistics.html" style="color: black">Les statistiques des matières par raport d'enseignants </a>
  <h1>   </h1>

  <a href="fet/timetables/file/file_students_statistics.html" style="color: black">Les statistiques des matières par raport d'apprenants </a><br><br>
</div>
